...
public class HealthBar : MonoBehaviour
{
    ...
    [SerializeField] private Heart _heartTeamplate;

    private List<Heart> _hearts = new List<Heart>();

    private void OnEnable()
    {
        _player.HealthChanged += OnHealthChaged;
    }
    ...
    private void OnHealthChaged(int value)
    {
    ...
    {
        Heart newHeart = Instantiate(_heartTeamplate, transform);
